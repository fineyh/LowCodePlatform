...
import { Canvas, CanvasStore, ElementItem, ElementsStore } from '@/interface'
...
let canvasStore: CanvasStore = useCanvasStore()
let elementsStore: ElementsStore = useElementsStore()
